...
#Rule commands :
    ...
    if message.content.startswith('r?rule 01'):
    ...
    if message.content.startswith('r?rule 2'):
    ...
    if message.content.startswith('r?rule 3'):
    ...
    if message.content.startswith('r?rule 4'):
    ...
    if message.content.startswith('r?rule 5'):
    ...
    if message.content.startswith('r?rule 6'):
    ...
    if message.content.startswith('r?rule 7'):
    ...
    if message.content.startswith('r?rule 8'):
    ...
    if message.content.startswith('r?rule 9'):
    ...
    if message.content.startswith('r?rule 10'):
